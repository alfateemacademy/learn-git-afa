              ...
              <div class="row column-seperation">
                <div class="col-md-6">
                  <h4>Basic Information</h4>            
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="inputDesignation" id="inputDesignation" type="text"  class="form-control" placeholder="Designation">
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="inputFacebookId" id="inputFacebookId" type="text"  class="form-control" placeholder="Facebook ID">
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="inputTwitterId" id="inputTwitterId" type="text"  class="form-control" placeholder="Twitter ID">
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="inputLinkedinId" id="inputLinkedinId" type="text"  class="form-control" placeholder="LinkedIn ID">
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">
                        <textarea name="inputMetaDescriptions" id="inputMetaDescriptions" rows="8" class="form-control" placeholder="Profile"></textarea>
                      </div>
                    </div>
                </div>
                <div class="col-md-6">
