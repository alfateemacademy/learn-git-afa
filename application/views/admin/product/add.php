              ...
              <div class="row column-seperation">
                <div class="col-md-6">
                  <h4>Basic Information</h4>            
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <select name="dropDownBrand" id="dropDownBrand" class="form-control">
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="inputCode" id="inputCode" type="text"  class="form-control" placeholder="Code">
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="inputCondition" id="inputCondition" type="text"  class="form-control" placeholder="Condition">
                      </div>
                    </div>  
                    <div class="row form-row">
                      <div class="col-md-12">
                        <input name="inputPrice" id="inputPrice" type="text"  class="form-control" placeholder="Price">
                      </div>
                    </div>
                    <div class="row form-row">
                      <div class="col-md-12">
                        <textarea name="inputDescriptions" id="inputDescriptions" rows="8" class="form-control" placeholder="Descriptions"></textarea>
