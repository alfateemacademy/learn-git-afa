              ...
              <div class="row column-seperation">
                <div class="col-md-6">
                  <h4>Basic Information</h4>            
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <select name="dropDownMediaType" id="dropDownMediaType" class="form-control">
                    ...
                    <div class="row form-row">
                      <div class="col-md-12">
                        <textarea name="inputEmbedCode" id="inputEmbedCode" rows="8" class="form-control" placeholder="Embed Code"></textarea>
                      </div>
                    </div>
                </div>
                <div class="col-md-6">
